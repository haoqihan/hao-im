...
func Bind(req *http.Request, obj interface{}) error {
	...
	if strings.Contains(strings.ToLower(contentType), "application/json") {
		return BandJson(req, obj)
	}
	// 判断是否是form类型
	if strings.Contains(strings.ToLower(contentType), "application/x-www-form-urlencoded") {
		return BandForm(req, obj)
	}
	return errors.New("当前方法暂时不支持")
}

// 绑定json
func BandJson(req *http.Request, obj interface{}) error {
...
// 绑定form
func BandForm(req *http.Request, obj interface{}) error {
	req.ParseForm()
